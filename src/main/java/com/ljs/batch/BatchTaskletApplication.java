...
public class BatchTaskletApplication {
	...
	public static void main(String[] args) throws NoSuchJobException, JobParametersInvalidException, JobExecutionAlreadyRunningException, JobRestartException, JobInstanceAlreadyCompleteException {
		ConfigurableApplicationContext appContext = SpringApplication.run(BatchTaskletApplication.class, args);
		...
		*/
		...
		JobExecution jobExecution = jobLauncher.run(jobRegistry.getJob("boardBatchTaskLetJob"), jobParametersBuilder.toJobParameters());
